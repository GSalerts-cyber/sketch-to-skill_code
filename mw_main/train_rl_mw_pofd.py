...
BC_POLICIES = {
    ...
    "ButtonPress": "~/BC_demo3_gen1/ButtonPress_epoch2_seed1/model1.pt",
    # "ButtonPressWall": "~/BC_IBRL/ButtonPressWall_epoch2_seed3/model1.pt",
    "Reach": "~/BC_IBRL_96_demo3_sketch/Reach_epoch2_seed1/model1.pt",
    "DrawerOpen": "~/BC_IBRL_96_demo3/DrawerOpen_epoch2_seed3/model1.pt",
    "ReachWall": "~/BC_IBRL_96_demo3_sketch/ReachWall_epoch2_seed3/model1.pt",
    "ButtonPressTopdownWall": "~/BC_IBRL_96_demo3/ButtonPressTopdownWall_epoch2_seed1/model1.pt",
    "CofeeButton": "~/BC_IBRL_96_demo3/CoffeeButton_epoch2_seed1/model1.pt",
}
...
BC_DATASETS = {
    ...
    # # "ButtonPressWall": "~/demo_dataset_bc_224_new/ButtonPressWall_frame_stack_1_224x224_end_on_success/dataset.hdf5",
    ...
    "ButtonPress": "~/raw_demo_servoring_data/ButtonPress_teachermodel_gen_1.hdf5",
    "DrawerOpen": "~/demo_dataset_bc_96_new/DrawerOpen_frame_stack_1_96x96_end_on_success/dataset_generated.hdf5",
    "Reach": "~/demo_dataset_bc_96_new/Reach_frame_stack_1_96x96_end_on_success/dataset_generated.hdf5",
    "CofeeButton": "~/demo_dataset_bc_96_new/CoffeeButton_frame_stack_1_96x96_end_on_success/dataset_generated.hdf5",
    "ReachWall": "~/demo_dataset_bc_96_new/ReachWall_frame_stack_1_96x96_end_on_success/dataset_generated.hdf5",
    "ButtonPressTopdownWall": "~/demo_dataset_bc_96_new/ButtonPressTopdownWall_frame_stack_1_96x96_end_on_success/dataset_generated.hdf5",
}

DISCRIMINATOR_DATASETS = {
    "ButtonPress": "~/raw_demo_servoring_data/ButtonPress_teachermodel_gen_10.hdf5",
}
...
class MainConfig(common_utils.RunConfig):
    ...
    # log
    use_wb: int = 0
    save_dir: str = "~/POFD_rew_weight_0_1"
...
class Workspace:
    ...
    def rl_train(self, stat: common_utils.MultiCounter):
        ...
        for i in range(self.cfg.num_critic_update):
            ...
            # TODO: hyperparameter search for reward weighting
...
if __name__ == "__main__":
    ...
    cfg.save_dir = f"~/IBRL_POfD_demo3_gen1/{cfg.bc_policy}_seed{cfg.seed}_rew_0_1"
    # cfg.save_dir = f"~/IBRL/{cfg.dataset.task_name}_epoch{cfg.num_epoch}_seed{cfg.seed}"
