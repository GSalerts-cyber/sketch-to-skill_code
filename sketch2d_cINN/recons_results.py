...
reconstructed_zip_path = '~/Teacher_student_RLsketch/sketch2d_cINN/reconstructed_images_finetuned_new.zip'
original_zip_path = '~/sketch_datasets/extracted_images.zip'
