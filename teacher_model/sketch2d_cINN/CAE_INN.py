...
visualization_path = '~/Teacher_student_RLsketch/sketch2d_cINN/mnist_resized_64/'
...
# num_epochs_mnist = 5
# mnist_reconstructed_path = '~/Teacher_student_RLsketch/sketch2d_cINN/reconstructed_mnist/'
...
zip_file_path = '~/sketch_datasets/extracted_images.zip'
...
zip_save_path = '~/Teacher_student_RLsketch/sketch2d_cINN/reconstructed_images_finetuned_eval.zip'
