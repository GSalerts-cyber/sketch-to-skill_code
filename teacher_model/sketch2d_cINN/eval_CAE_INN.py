...
if __name__ == "__main__":
    root_dir = "~/Teacher_student_RLsketch/saved_models"
    ...
    model.load_state_dict(torch.load('~/Teacher_student_RLsketch/saved_models/vae_cinn_finetuning_train/vae_cinn_finetuned_epoch_5.pth'))
    path = '~/Teacher_student_RLsketch/saved_models/vae_cinn_finetuning_train/vae_cinn_finetuned_epoch_5.pth'
