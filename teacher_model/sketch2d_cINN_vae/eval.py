...
def visualize_trajectory(sketches, recons, trajectories, fitted_trajectories, generated_trajectories, img_name):
    ...
    plt.tight_layout()
    plt.savefig(f'~/Teacher_student_RLsketch/eval_results2/generated_trajectory_{img_name}.png')
...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load('~/2024-09-12_23-25-45_bs128_ns200000_lr0.0001_kld0.01_epochs500/bspline_cinn_model_bs128_ns200000_lr0.0001_kld0.01_epochs500.pth'))
