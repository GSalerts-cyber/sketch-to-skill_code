...
# environments = ["ButtonPress", "Reach", "ReachWall", "ButtonPressTopdownWall","CoffeeButton"]
environments = ["Assembly", "BoxClose", "CoffeePush"]
# environments = ["ButtonPressTopdownWall"]
seeds = [0, 1, 2, 3, 4]
...
for env in environments:
    for seed in seeds:
        ...
        python_command = (
            f"python train_bc_mw.py "
            f"--dataset.path {env} "
            f"--dataset.num_data 3 "
            f"--num_epoch 2 "
            f"--seed {seed}"
        )
